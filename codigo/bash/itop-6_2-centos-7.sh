#!/bin/bash
#==============================================================================
# Instalación de iTop 6.2 en CentOS 7
# 
# Uso:
...
#==============================================================================
yum --enablerepo=remi,remi-php72 -y install php php-zip php-mysql php-xml php-xmlrpc php-ldap php-gd php-soap php-intl php-mbstring php-mcrypt
